...
\begin{center}
	\begin{tabular}{@{}ll@{}}
		...
		\textbf{1.0646048} & \textbf{Total}          \\ \bottomrule
	\end{tabular}
...
Overall, just 1.06\% of CPU time was devoted to the CFS scheduler. While this may seem like a negligible amount of time, the CPU presented 8 logical cores for scheduling and operated at 3.25 GHz, equating to:
\begin{equation*}
	3.25\ \text{GHz}*0.0106*8 = 276.8\ \text{MHz}
\end{equation*}

276.8 million cycles wasted each second. FLASH is intended to return most of those cycles back to the CPU to perform useful work.
