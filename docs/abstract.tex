...
An additional metric is cache and TLB misses and overall cycle count, attainable through the use of the \verb|perf| tool. We provide the results for the CFS scheduler as of Linux 3.19.2; we will also provide the SoC results upon completion.
